...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.homevc.managedObjectContext = self.managedObjectContext;
...
- (void)saveTemp
{
    NSString *tempstring = [TempData getTempString];
    if (tempstring) {
        [self insertTempEntity:tempstring];
...
{
    Temp *temp = [NSEntityDescription insertNewObjectForEntityForName:@"Temp" inManagedObjectContext:[self managedObjectContext]];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Drivingskill" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Drivingskill.sqlite"];
